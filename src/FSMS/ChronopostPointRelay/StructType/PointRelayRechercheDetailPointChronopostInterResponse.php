...
class PointRelayRechercheDetailPointChronopostInterResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRechercheDetailPointChronopostInterResponse::setReturn()
     ...
     * Set return value
     * @param \FSMS\ChronopostPointRelay\StructType\PointRelayPointCHRResult $return
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRechercheDetailPointChronopostInterResponse
     */
