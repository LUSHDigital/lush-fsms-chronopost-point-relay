...
class PointRelayPeriodeFermeture extends AbstractStructBase
{
    /**
     * The calendarDeDebut
     ...
     * @uses PointRelayPeriodeFermeture::setCalendarDeDebut()
     * @uses PointRelayPeriodeFermeture::setCalendarDeFin()
     * @uses PointRelayPeriodeFermeture::setNumero()
