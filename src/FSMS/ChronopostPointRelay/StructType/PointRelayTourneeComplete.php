...
class PointRelayTourneeComplete extends PointRelayTournee
{
    /**
     ...
     * @uses PointRelayTourneeComplete::setCodeTourneeMaitre()
     * @uses PointRelayTourneeComplete::setCodeTypeTournee()
     * @uses PointRelayTourneeComplete::setCoutMensuelBatiment()
     * @uses PointRelayTourneeComplete::setCubage()
     * @uses PointRelayTourneeComplete::setCubageDistri()
     * @uses PointRelayTourneeComplete::setDetailPrestation()
     * @uses PointRelayTourneeComplete::setHeureTheoriqueRetour()
     * @uses PointRelayTourneeComplete::setIdMoyenPropre()
     * @uses PointRelayTourneeComplete::setIdSecteur()
     * @uses PointRelayTourneeComplete::setIdSousTraitant()
     * @uses PointRelayTourneeComplete::setIdVehicule()
     * @uses PointRelayTourneeComplete::setPicking()
     * @uses PointRelayTourneeComplete::setPlanDistri()
     * @uses PointRelayTourneeComplete::setPosteComptable()
     * @uses PointRelayTourneeComplete::setPourcentageCoChargement()
     * @uses PointRelayTourneeComplete::setQualification()
     * @uses PointRelayTourneeComplete::setSpot()
     * @uses PointRelayTourneeComplete::setTrigrammeAgence()
     * @uses PointRelayTourneeComplete::setTypeTournee()
     * @uses PointRelayTourneeComplete::setZone()
     ...
     * @param string $codeTourneeMaitre
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayTourneeComplete
     */
