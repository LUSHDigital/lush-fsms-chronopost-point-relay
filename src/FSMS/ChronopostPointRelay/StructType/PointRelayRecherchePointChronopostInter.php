...
class PointRelayRecherchePointChronopostInter extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRecherchePointChronopostInter::setAccountNumber()
     * @uses PointRelayRecherchePointChronopostInter::setPassword()
     * @uses PointRelayRecherchePointChronopostInter::setAddress()
     * @uses PointRelayRecherchePointChronopostInter::setZipCode()
     * @uses PointRelayRecherchePointChronopostInter::setCity()
     * @uses PointRelayRecherchePointChronopostInter::setCountryCode()
     * @uses PointRelayRecherchePointChronopostInter::setType()
     * @uses PointRelayRecherchePointChronopostInter::setProductCode()
     * @uses PointRelayRecherchePointChronopostInter::setService()
     * @uses PointRelayRecherchePointChronopostInter::setWeight()
     * @uses PointRelayRecherchePointChronopostInter::setShippingDate()
     * @uses PointRelayRecherchePointChronopostInter::setMaxPointChronopost()
     * @uses PointRelayRecherchePointChronopostInter::setMaxDistanceSearch()
     * @uses PointRelayRecherchePointChronopostInter::setHolidayTolerant()
     * @uses PointRelayRecherchePointChronopostInter::setLanguage()
     * @uses PointRelayRecherchePointChronopostInter::setVersion()
     ...
     * @param string $accountNumber
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRecherchePointChronopostInter
     */
