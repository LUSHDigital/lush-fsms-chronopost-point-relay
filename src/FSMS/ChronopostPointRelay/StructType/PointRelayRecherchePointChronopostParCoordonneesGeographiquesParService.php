...
class PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setAccountNumber()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setPassword()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setCountryCode()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setCoordGeoLatitude()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setCoordGeoLongitude()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setType()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setProductCode()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setService()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setWeight()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setShippingDate()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setMaxPointChronopost()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setMaxDistanceSearch()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setHolidayTolerant()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setServiceList()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService::setLanguage()
     ...
     * @param string $accountNumber
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRecherchePointChronopostParCoordonneesGeographiquesParService
     */
