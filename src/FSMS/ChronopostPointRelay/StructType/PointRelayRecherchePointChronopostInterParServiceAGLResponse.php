...
class PointRelayRecherchePointChronopostInterParServiceAGLResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRecherchePointChronopostInterParServiceAGLResponse::setReturn()
     ...
     * Set return value
     * @param \FSMS\ChronopostPointRelay\StructType\PointRelayPointCHRResult $return
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRecherchePointChronopostInterParServiceAGLResponse
     */
