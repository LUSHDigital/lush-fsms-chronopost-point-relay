...
class PointRelayRecherchePointChronopostInterParServiceAGL extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setAccountNumber()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setPassword()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setAddress()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setZipCode()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setCity()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setCountryCode()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setType()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setProductCode()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setService()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setWeight()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setShippingDate()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setMaxPointChronopost()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setMaxDistanceSearch()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setHolidayTolerant()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setServiceList()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setLanguage()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setVersion()
     * @uses PointRelayRecherchePointChronopostInterParServiceAGL::setAmaGeoLoc()
     ...
     * @param string $accountNumber
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRecherchePointChronopostInterParServiceAGL
     */
