...
class PointRelayRecherchePointChronopostInterParService extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRecherchePointChronopostInterParService::setAccountNumber()
     * @uses PointRelayRecherchePointChronopostInterParService::setPassword()
     * @uses PointRelayRecherchePointChronopostInterParService::setAddress()
     * @uses PointRelayRecherchePointChronopostInterParService::setZipCode()
     * @uses PointRelayRecherchePointChronopostInterParService::setCity()
     * @uses PointRelayRecherchePointChronopostInterParService::setCountryCode()
     * @uses PointRelayRecherchePointChronopostInterParService::setType()
     * @uses PointRelayRecherchePointChronopostInterParService::setProductCode()
     * @uses PointRelayRecherchePointChronopostInterParService::setService()
     * @uses PointRelayRecherchePointChronopostInterParService::setWeight()
     * @uses PointRelayRecherchePointChronopostInterParService::setShippingDate()
     * @uses PointRelayRecherchePointChronopostInterParService::setMaxPointChronopost()
     * @uses PointRelayRecherchePointChronopostInterParService::setMaxDistanceSearch()
     * @uses PointRelayRecherchePointChronopostInterParService::setHolidayTolerant()
     * @uses PointRelayRecherchePointChronopostInterParService::setServiceList()
     * @uses PointRelayRecherchePointChronopostInterParService::setLanguage()
     * @uses PointRelayRecherchePointChronopostInterParService::setVersion()
     ...
     * @param string $accountNumber
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRecherchePointChronopostInterParService
     */
