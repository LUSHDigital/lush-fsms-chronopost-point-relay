...
class PointRelayPointChronopostAvecCoord extends PointRelayPointChronopost
{
    /**
     ...
     * @uses PointRelayPointChronopostAvecCoord::setCoordGeoLatitude()
     * @uses PointRelayPointChronopostAvecCoord::setCoordGeoLongitude()
