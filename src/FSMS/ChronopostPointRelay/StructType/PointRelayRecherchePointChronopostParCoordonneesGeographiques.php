...
class PointRelayRecherchePointChronopostParCoordonneesGeographiques extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setAccountNumber()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setPassword()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setCoordGeoLatitude()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setCoordGeoLongitude()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setType()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setProductCode()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setService()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setWeight()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setShippingDate()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setMaxPointChronopost()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setMaxDistanceSearch()
     * @uses PointRelayRecherchePointChronopostParCoordonneesGeographiques::setHolidayTolerant()
     ...
     * @param string $accountNumber
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRecherchePointChronopostParCoordonneesGeographiques
     */
