...
class PointRelayRechercheBtParIdChronopostA2PasResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRechercheBtParIdChronopostA2PasResponse::setReturn()
    ...
    public static function validateReturnForArrayConstraintFromSetReturn(?array $values = []): string
    {
        ...
        foreach ($values as $rechercheBtParIdChronopostA2PasResponseReturnItem) {
            ...
            if (!$rechercheBtParIdChronopostA2PasResponseReturnItem instanceof \FSMS\ChronopostPointRelay\StructType\PointRelayBureauDeTabacAvecCoord) {
     ...
     * @param \FSMS\ChronopostPointRelay\StructType\PointRelayBureauDeTabacAvecCoord[] $return
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRechercheBtParIdChronopostA2PasResponse
     */
