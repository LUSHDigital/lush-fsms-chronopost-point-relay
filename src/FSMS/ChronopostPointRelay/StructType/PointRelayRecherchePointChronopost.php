...
class PointRelayRecherchePointChronopost extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRecherchePointChronopost::setAccountNumber()
     * @uses PointRelayRecherchePointChronopost::setPassword()
     * @uses PointRelayRecherchePointChronopost::setAddress()
     * @uses PointRelayRecherchePointChronopost::setZipCode()
     * @uses PointRelayRecherchePointChronopost::setCity()
     * @uses PointRelayRecherchePointChronopost::setCountryCode()
     * @uses PointRelayRecherchePointChronopost::setType()
     * @uses PointRelayRecherchePointChronopost::setProductCode()
     * @uses PointRelayRecherchePointChronopost::setService()
     * @uses PointRelayRecherchePointChronopost::setWeight()
     * @uses PointRelayRecherchePointChronopost::setShippingDate()
     * @uses PointRelayRecherchePointChronopost::setMaxPointChronopost()
     * @uses PointRelayRecherchePointChronopost::setMaxDistanceSearch()
     * @uses PointRelayRecherchePointChronopost::setHolidayTolerant()
     ...
     * @param string $accountNumber
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRecherchePointChronopost
     */
