...
class PointRelayPointChronopost extends AbstractStructBase
{
    /**
     * The adresse1
     ...
     * @uses PointRelayPointChronopost::setAdresse1()
     * @uses PointRelayPointChronopost::setAdresse2()
     * @uses PointRelayPointChronopost::setAdresse3()
     * @uses PointRelayPointChronopost::setCodePostal()
     * @uses PointRelayPointChronopost::setDateArriveColis()
     * @uses PointRelayPointChronopost::setHorairesOuvertureDimanche()
     * @uses PointRelayPointChronopost::setHorairesOuvertureJeudi()
     * @uses PointRelayPointChronopost::setHorairesOuvertureLundi()
     * @uses PointRelayPointChronopost::setHorairesOuvertureMardi()
     * @uses PointRelayPointChronopost::setHorairesOuvertureMercredi()
     * @uses PointRelayPointChronopost::setHorairesOuvertureSamedi()
     * @uses PointRelayPointChronopost::setHorairesOuvertureVendredi()
     * @uses PointRelayPointChronopost::setHorairesOuverturesFormates()
     * @uses PointRelayPointChronopost::setIdentifiantChronopost()
     * @uses PointRelayPointChronopost::setLocalite()
     * @uses PointRelayPointChronopost::setNomEnseigne()
     * @uses PointRelayPointChronopost::setTypeDePoint()
