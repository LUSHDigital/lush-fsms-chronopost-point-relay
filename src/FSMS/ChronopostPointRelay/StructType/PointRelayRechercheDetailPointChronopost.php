...
class PointRelayRechercheDetailPointChronopost extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRechercheDetailPointChronopost::setAccountNumber()
     * @uses PointRelayRechercheDetailPointChronopost::setPassword()
     * @uses PointRelayRechercheDetailPointChronopost::setIdentifiant()
     ...
     * @param string $accountNumber
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRechercheDetailPointChronopost
     */
