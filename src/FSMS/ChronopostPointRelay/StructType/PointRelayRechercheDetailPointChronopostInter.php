...
class PointRelayRechercheDetailPointChronopostInter extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRechercheDetailPointChronopostInter::setAccountNumber()
     * @uses PointRelayRechercheDetailPointChronopostInter::setPassword()
     * @uses PointRelayRechercheDetailPointChronopostInter::setIdentifiant()
     * @uses PointRelayRechercheDetailPointChronopostInter::setCountryCode()
     * @uses PointRelayRechercheDetailPointChronopostInter::setLanguage()
     * @uses PointRelayRechercheDetailPointChronopostInter::setVersion()
     ...
     * @param string $accountNumber
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRechercheDetailPointChronopostInter
     */
