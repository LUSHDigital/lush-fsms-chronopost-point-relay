...
class PointRelayRecherchePointChronopostParIdResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRecherchePointChronopostParIdResponse::setReturn()
    ...
    public static function validateReturnForArrayConstraintFromSetReturn(?array $values = []): string
    {
        ...
        foreach ($values as $recherchePointChronopostParIdResponseReturnItem) {
            ...
            if (!$recherchePointChronopostParIdResponseReturnItem instanceof \FSMS\ChronopostPointRelay\StructType\PointRelayPointChronopost) {
     ...
     * @param \FSMS\ChronopostPointRelay\StructType\PointRelayPointChronopost[] $return
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRecherchePointChronopostParIdResponse
     */
