...
class PointRelayTournee extends AbstractStructBase
{
    /**
     * The code
     ...
     * @uses PointRelayTournee::setCode()
     * @uses PointRelayTournee::setLocalise()
     * @uses PointRelayTournee::setType()
     * @param string $code
     * @param bool $localise
     * @param string $type
     */
     ...
     * Set code value
     * @param string $code
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayTournee
     */
