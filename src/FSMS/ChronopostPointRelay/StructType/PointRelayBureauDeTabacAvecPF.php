...
class PointRelayBureauDeTabacAvecPF extends PointRelayBureauDeTabacAvecCoord
{
    /**
     ...
     * @uses PointRelayBureauDeTabacAvecPF::setPeriodeDeFermeture1Debut()
     * @uses PointRelayBureauDeTabacAvecPF::setPeriodeDeFermeture1Fin()
     * @uses PointRelayBureauDeTabacAvecPF::setPeriodeDeFermeture2Debut()
     * @uses PointRelayBureauDeTabacAvecPF::setPeriodeDeFermeture2Fin()
     * @uses PointRelayBureauDeTabacAvecPF::setPeriodeDeFermeture3Debut()
     * @uses PointRelayBureauDeTabacAvecPF::setPeriodeDeFermeture3Fin()
