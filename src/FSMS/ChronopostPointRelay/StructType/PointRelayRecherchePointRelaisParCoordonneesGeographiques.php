...
class PointRelayRecherchePointRelaisParCoordonneesGeographiques extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setAccountNumber()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setPassword()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setCoordGeoLatitude()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setCoordGeoLongitude()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setType()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setProductCode()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setService()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setWeight()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setShippingDate()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setMaxPointChronopost()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setMaxDistanceSearch()
     * @uses PointRelayRecherchePointRelaisParCoordonneesGeographiques::setHolidayTolerant()
     ...
     * @param string $accountNumber
     * @return \FSMS\ChronopostPointRelay\StructType\PointRelayRecherchePointRelaisParCoordonneesGeographiques
     */
